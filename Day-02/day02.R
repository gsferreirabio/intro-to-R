...
setwd("d:/R Projects/Intro-to-R/")  ## set your working directory
...
daphnia.data = read.table(file = "datasets/daphnia.txt", header = T)  
daphnia.data
class(daphnia.data)
...
F24.size = read.table("datasets/Ferreira_etal-2024/size-meas.csv", header = TRUE)
...
F24.size.csv = read.csv("datasets/Ferreira_etal-2024/size-meas.csv", header = TRUE)
...
F24.size = read.table("datasets/Ferreira_etal-2024/size-meas.csv", sep = ",", 
                      header = TRUE)

identical(F24.size.csv, F24.size)  ## they are identical

# In the folder Godoy_etal-2019 we have a .xlsx file, how to read it?
read.table("datasets/Godoy_etal-2019/G19-dataset.xlsx", header = T)
read.csv("datasets/Godoy_etal-2019/G19-dataset.xlsx", header = T)
...
?read_excel()
G19.data = read_excel("datasets/Godoy_etal-2019/G19-dataset.xlsx")
